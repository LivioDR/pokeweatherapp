        ...
        <div className="currentWeatherCard" style={containerStyle}>
            ...
            <div className="currentCardBody" style={cardBodyStyle}>
                <div className="currentCardText" style={textStyle}>
                    ...
                    <p style={currentCardTextPStyles}><i className="fi fi-rr-temperature-high"></i> {Math.round(Number(temperature))}{units.temperature}</p>
                    <p style={currentCardTextPStyles}><i className="fi fi-sr-wind"></i> {Math.round(Number(windspeed))} {units.windspeed}</p>
                </div>
                <img 
